...
const options = ['LVCC Central Hall', 'DOOR 9 near Blue Lot']

export default function SelectReportLocation({
  selected,
  onSelect,
  onNext,
  onBack,
      ...
      <View className="w-full max-w-[768px] self-center">
        ...
        <View className="mt-4 items-center">
          <Title
            ...
            subtitle="This information will be used to preload the data associated to the location"
          />
        </View>
      </View>
